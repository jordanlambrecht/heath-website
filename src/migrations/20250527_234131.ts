...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_poems_analysis_display_analysis_location" AS ENUM('top', 'bottom');
  CREATE TYPE "public"."enum_poems_description_description_location" AS ENUM('top', 'bottom');
  CREATE TYPE "public"."enum_poems_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__poems_v_version_analysis_display_analysis_location" AS ENUM('top', 'bottom');
  CREATE TYPE "public"."enum__poems_v_version_description_description_location" AS ENUM('top', 'bottom');
  ...
  CREATE TABLE IF NOT EXISTS "poems" (
  	...
  	"hero_image_id" integer,
  	"content" jsonb,
  	"analysis_enable" boolean DEFAULT false,
  	"analysis_display_display_analysis" boolean DEFAULT false,
  	"analysis_display_display_title" boolean DEFAULT true,
  	"analysis_display_analysis_location" "enum_poems_analysis_display_analysis_location" DEFAULT 'bottom',
  	"analysis_display_treat_as_spoiler" boolean DEFAULT false,
  	"analysis_analysis_title" varchar DEFAULT 'Analysis',
  	"analysis_analysis_text" jsonb,
  	"meta_title" varchar,
  	"meta_image_id" integer,
  	"meta_description" varchar,
  	"description_enable_description" boolean DEFAULT false,
  	"description_display_description" boolean DEFAULT false,
  	"description_description_location" "enum_poems_description_description_location" DEFAULT 'top',
  ...
  CREATE TABLE IF NOT EXISTS "poems_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_poems_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_hero_image_id" integer,
  	"version_content" jsonb,
  	"version_analysis_enable" boolean DEFAULT false,
  	"version_analysis_display_display_analysis" boolean DEFAULT false,
  	"version_analysis_display_display_title" boolean DEFAULT true,
  	"version_analysis_display_analysis_location" "enum__poems_v_version_analysis_display_analysis_location" DEFAULT 'bottom',
  	"version_analysis_display_treat_as_spoiler" boolean DEFAULT false,
  	"version_analysis_analysis_title" varchar DEFAULT 'Analysis',
  	"version_analysis_analysis_text" jsonb,
  	"version_meta_title" varchar,
  	"version_meta_image_id" integer,
  	"version_meta_description" varchar,
  	"version_description_enable_description" boolean DEFAULT false,
  	"version_description_display_description" boolean DEFAULT false,
  	"version_description_description_location" "enum__poems_v_version_description_description_location" DEFAULT 'top',
  	"version_description_description" varchar,
  	"version_published_at" timestamp(3) with time zone,
  	"version_slug" varchar,
  	"version_slug_lock" boolean DEFAULT true,
  	"version_updated_at" timestamp(3) with time zone,
  ...
  CREATE TABLE IF NOT EXISTS "_poems_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "poems" ADD CONSTRAINT "poems_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "poems" ADD CONSTRAINT "poems_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "poems_rels" ADD CONSTRAINT "poems_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."poems"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "poems_rels" ADD CONSTRAINT "poems_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_poems_v" ADD CONSTRAINT "_poems_v_version_hero_image_id_media_id_fk" FOREIGN KEY ("version_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_poems_v" ADD CONSTRAINT "_poems_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_poems_v_rels" ADD CONSTRAINT "_poems_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_poems_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_poems_v_rels" ADD CONSTRAINT "_poems_v_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_poems_fk" FOREIGN KEY ("poems_id") REFERENCES "public"."poems"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "poems_hero_image_idx" ON "poems" USING btree ("hero_image_id");
  CREATE INDEX IF NOT EXISTS "poems_meta_meta_image_idx" ON "poems" USING btree ("meta_image_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "poems_slug_idx" ON "poems" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "poems_updated_at_idx" ON "poems" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "poems_created_at_idx" ON "poems" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "poems__status_idx" ON "poems" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "poems_rels_order_idx" ON "poems_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "poems_rels_parent_idx" ON "poems_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "poems_rels_path_idx" ON "poems_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "poems_rels_categories_id_idx" ON "poems_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "_poems_v_parent_idx" ON "_poems_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_poems_v_version_version_hero_image_idx" ON "_poems_v" USING btree ("version_hero_image_id");
  CREATE INDEX IF NOT EXISTS "_poems_v_version_meta_version_meta_image_idx" ON "_poems_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_poems_v_version_version_slug_idx" ON "_poems_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_poems_v_version_version_updated_at_idx" ON "_poems_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_poems_v_version_version_created_at_idx" ON "_poems_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_poems_v_version_version__status_idx" ON "_poems_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_poems_v_created_at_idx" ON "_poems_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_poems_v_updated_at_idx" ON "_poems_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_poems_v_latest_idx" ON "_poems_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_poems_v_autosave_idx" ON "_poems_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "_poems_v_rels_order_idx" ON "_poems_v_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_poems_v_rels_parent_idx" ON "_poems_v_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_poems_v_rels_path_idx" ON "_poems_v_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "_poems_v_rels_categories_id_idx" ON "_poems_v_rels" USING btree ("categories_id");
  ...
  CREATE INDEX IF NOT EXISTS "redirects_rels_poems_id_idx" ON "redirects_rels" USING btree ("poems_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_poems_id_idx" ON "payload_locked_documents_rels" USING btree ("poems_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "poems_rels" CASCADE;
  DROP TABLE "_poems_v" CASCADE;
  DROP TABLE "_poems_v_rels" CASCADE;
  ...
  DROP TYPE "public"."enum_poems_analysis_display_analysis_location";
  DROP TYPE "public"."enum_poems_description_description_location";
  DROP TYPE "public"."enum_poems_status";
  DROP TYPE "public"."enum__poems_v_version_analysis_display_analysis_location";
  DROP TYPE "public"."enum__poems_v_version_description_description_location";
